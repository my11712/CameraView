...
//    private static final String TAG = "JCameraView";
    ...
    private boolean showFlash;         //是否显示闪光灯
    //缩放梯度
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        showFlash = a.getBoolean(R.styleable.JCameraView_showFlash, false);
        a.recycle();
        initData();
        initView();
    }
    ...
    private void initView() {
        ...
        mFoucsView = (FoucsView) view.findViewById(R.id.focus_view);
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    private void setFlashViewVisible() {
        if (showFlash) {
