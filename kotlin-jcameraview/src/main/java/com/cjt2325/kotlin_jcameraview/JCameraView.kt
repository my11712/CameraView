...
import com.cjt2325.kotlin_jcameraview.listener.JCameraListener
...
class JCameraView : FrameLayout, TextureView.SurfaceTextureListener {
    ...
    private var jCameraListener:JCameraListener?=null
...
//        i("onSurfaceTextureUpdated")
    ...
    fun setJCameraListener(jCameraListener: JCameraListener){
        this.jCameraListener=jCameraListener
    }

    fun setSaveVideoPath(saveVideoPath: String) {
        CameraNewInterface.getInstance().setSaveVideoPath(saveVideoPath)
    }
}